			...
			<div class="col-md-12">
				<ul class="top-header-bar">
					...
					<?php if ( class_exists( 'WooCommerce' ) ) : ?>
						<!-- Cart -->
						<li class="top-cart">
							<a href="<?php echo esc_url( Tyche_Helper::get_woocommerge_page( 'cart' ) ); ?>"><i class="fa fa-shopping-cart"></i> <?php echo esc_html__( 'Giỏ Hàng', 'tyche' ); ?> : <?php echo ' <span class="price">' . esc_html( Tyche_WooCommerce_Hooks::get_cart_total() ) . '</span>'.' '.esc_html( get_woocommerce_currency_symbol( get_woocommerce_currency() ) ); ?>
							</a>
						</li> <!-- / Cart -->
					<?php endif; ?>
